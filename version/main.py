...
makedirs(save_pkg_dir, exist_ok=True)
...
arg_parser.add_argument("-n", "--name", type=str, default=base_pkg_filename, help="""Names the file downloaded via --get. Usage example: -g --url https://example.com/file.txt --name cool.txt to download the file.txt from the URL and save it as cool.txt.""")
